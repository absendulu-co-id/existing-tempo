...
interface Props {
  ...
  innerScroll?: boolean;
  leftSidebarVariant?: React.ReactNode;
  rightSidebarVariant?: React.ReactNode;
...
const FusePageCarded = (props, ref) => {
  ...
  React.useImperativeHandle(ref, () => {
    return {
      rootRef,
      toggleLeftSidebar: () => {
        (leftSidebarRef.current as any)?.toggleSidebar();
      },
      toggleRightSidebar: () => {
        (rightSidebarRef.current as any)?.toggleSidebar();
      },
    };
  });
    ...
    <div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
      ...
      <div className="flex container w-full">
        ...
        >
          ...
          <div
            className={clsx(classes.contentCard, props.innerScroll && "inner-scroll")}
...
export default React.memo(React.forwardRef<unknown, Props>(FusePageCarded));
