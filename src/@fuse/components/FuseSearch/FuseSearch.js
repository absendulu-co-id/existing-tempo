      ...
      {variant === "basic" ? (
        ...
        <React.Fragment>
          <TextField
            ...
            InputProps={{
              ...
              classes: {
                input: clsx(classes.input, "py-0 px-16 pr-48"),
            ...
            {...other}
          />
          <Icon className="absolute top-0 right-0 p-12 pointer-events-none" color="action">
            search
          </Icon>
        </React.Fragment>
      ) : (
        ...
        <TextField
          ...
          InputProps={{
            ...
            classes: {
              input: clsx(classes.input, "py-0 px-16"),
            },
          }}
          variant="standard"
          {...other}
...
function FuseSearch(props) {
  ...
  useEffect(() => {
    function itemAuthAllowed(item) {
      return FuseUtils.hasPermission(item.auth);
    }
        ...
        <div className={clsx(classes.root, "flex", props.className)}>
          ...
          {state.opened && (
            <ClickAwayListener onClickAway={handleClickAway}>
              <Paper className="absolute left-0 right-0 z-9999" square={true}>
